...
def start_order(chat_id):
    ...
    send_message(
        chat_id,
        "Welcome! Upload your ID using /id and send your location with /location."
        " Once verified, use /menu to start your order.",
    )
...
def review_order(chat_id):
    """Show summary of the order and prompt for payment."""
...
def finalize_order(chat_id):
    """Send final order summary including payment and notify admin."""
    data = sessions.get(chat_id, {})
