...
def webhook():
    ...
    if 'message' in data:
        ...
        elif 'cannabis' in text:
            reply_markup = {
                "keyboard": [
                    [{"text": "Permanent Marker"}, {"text": "Lemon Smack"}],
                    [{"text": "Kush Mints"}, {"text": "Island Express"}],
                    [{"text": "1/8th $60"}, {"text": "7G $110"}],
                    [{"text": "14G $200"}, {"text": "Oz $400"}]
                ],
                "resize_keyboard": True,
                "one_time_keyboard": True
            }
            send_message(chat_id, "🌿 *Select your strain and quantity:*", reply_markup=reply_markup)
        elif 'hookah' in text:
            reply_markup = {
                "keyboard": [
                    [{"text": "🟠 Orange Head $40"}, {"text": "🍊 Grapefruit Head $50"}],
                    [{"text": "🍋 Lemon Mint"}, {"text": "🍎 Double Apple"}],
                    [{"text": "🍇 Grape"}, {"text": "🍇🍃 Grape Mint"}]
                ],
                "resize_keyboard": True,
                "one_time_keyboard": True
            }
            send_message(chat_id, "💨 *Select your hookah head and flavor:*", reply_markup=reply_markup)
        elif 'liquor' in text:
            reply_markup = {
                "keyboard": [
                    [{"text": "Hennessy $75"}, {"text": "Casamigos $75"}],
                    [{"text": "📝 Request something else"}]
                ],
                "resize_keyboard": True,
                "one_time_keyboard": True
            }
            send_message(chat_id, "🥃 *Select your drink or type a request. We’ll respond with a price ASAP.*", reply_markup=reply_markup)
